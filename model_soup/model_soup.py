...
def main(args):
    ...
    models_path = {
        ...
        "record/models/cityflow_frozen_cg-wf/3/checkpoint-latest.pth": 58.80149226295106,
        "record/models/cityflow_frozen_cg-wf/4/checkpoint-latest.pth": 59.04275354876265,
        "record/models/cityflow_frozen_cg-wf/10/checkpoint-latest.pth": 59.22375592753993,
        "record/models/cityflow_frozen_cg-wf/11/checkpoint-latest.pth": 58.57664191323542
    }

    models_path = {k: v for k, v in sorted(models_path.items(), key=lambda item: item[1], reverse=True)}
    print(models_path)
